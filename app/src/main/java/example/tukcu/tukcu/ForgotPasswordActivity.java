...
public class ForgotPasswordActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Reset TUK CU Password");
                    ...
                    mAuth.sendPasswordResetEmail(email).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                           if (task.isSuccessful()){
                               ...
                               Toast.makeText(ForgotPasswordActivity.this, "Error in sending reset email.. please check your internet connection or your email and try again.", Toast.LENGTH_LONG).show();
                               dialog.dismiss();
                           }
                        }
                    });
